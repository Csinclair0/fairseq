...
--max-update 1 --validate-interval-updates 1000  --max-tokens-valid 1024 \
--eval-bleu  --label-smoothing 0.2 --update-freq 2 --arch mbart_large \
--no-last-checkpoints \
--eval-bleu-args  '{"beam": 5, "max_len_a": 1.2, "max_len_b": 10}' \
--eval-bleu-detok-args '{"bpe" : "sentencepiece", "sentencepiece_model" : "/Users/csinclair/Downloads/mbart50.ft.1n/sentence.bpe.model"}' \
